        ...
        while (true) {
            ...
            if (choix == 1) {
                ...
                if (choixCreate == 1) {
                    ...
                    while (!dossier.isDirectory()) {
                        if (cheminDossier.equals("ECHAP")) {
                            break;
                        }
                        System.out.println("Le chemin n'est pas un dossier, veuillez entrer un chemin valide ou tapez ECHAP pour revenir au menu principal : ");
